...
export function Meta({ title, description, imageUrl, timestamp }: MetaProps) {
  return (
    <Head>
      <title>Beckett - {title}</title>
      <meta name="description" content={description} key="description" />
      <meta property="og:title" content={`Beckett - ${title}`} key="title" />
      ...
      <meta name="twitter:site" content="@BeckettMedia" key="twittersite" />
      <meta
      ...
      <meta name="keywords" key="keywords" content="Vault, Asset, NFT" />
    </Head>
  );
}
